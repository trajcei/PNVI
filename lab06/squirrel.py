...
def runGame():
    ...
    gameOverRect.center = (HALF_WINWIDTH, HALF_WINHEIGHT-100)
    ...
    while True: # main game loop
        ...
        if (camerax + HALF_WINWIDTH) - playerCenterx > HCAMERASLACK:
            camerax = playerCenterx + HCAMERASLACK - HALF_WINWIDTH
        elif playerCenterx - (camerax + HALF_WINWIDTH) > HCAMERASLACK:
            camerax = playerCenterx - HCAMERASLACK - HALF_WINWIDTH
        if (cameray + HALF_WINHEIGHT) - playerCentery > VCAMERASLACK:
            cameray = playerCentery + VCAMERASLACK - HALF_WINHEIGHT
        elif playerCentery - (cameray + HALF_WINHEIGHT) > VCAMERASLACK:
            cameray = playerCentery - VCAMERASLACK - HALF_WINHEIGHT
...
def makeNewSquirrel(camerax, cameray):
    ...
    sq['pcrandom'] = random.randint(1,5)
